...
//rely upon const rvalue life extension to maintain the test 
...
#define ECE297_TIME_CONSTRAINT(ms) UnitTest::TestDetails unitTest__timeConstraint_details__(m_details, __LINE__); UnitTest::TimeConstraint unitTest__timeConstraint__(ms, unitTest__timeConstraint_details__)