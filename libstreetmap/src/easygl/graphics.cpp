...
//    menu_attributes.event_mask = 0;
  ...
  //  strcpy(button_state.button[7].text, "Window");
    strcpy(button_state.button[7].text, "Refresh");
    strcpy(button_state.button[8].text, "PostScript");
    strcpy(button_state.button[9].text, "Proceed");
...
//    button_state.button[7].fcn = adjustwin; // see 'adjustButton' below in WIN32 section
    button_state.button[7].fcn = zoom_fit;
    button_state.button[8].fcn = postscript;
