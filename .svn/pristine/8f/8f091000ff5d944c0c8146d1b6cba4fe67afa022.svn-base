...
#
CUSTOM_COMPILE_FLAGS = $(shell pkg-config --cflags x11 xft fontconfig cairo) -fopenmp -lpython2.7
CUSTOM_LINK_FLAGS    = $(shell pkg-config --libs x11 xft fontconfig cairo) -fopenmp -lreadline -lpython2.7
